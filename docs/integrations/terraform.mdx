...
<Warning>
The provider is not yet published in the Terraform Registry. The public beta provides source and
attested multi-platform ZIPs on the
[`v1.0.0-rc.1` prerelease](https://github.com/infercrane/infercrane/releases/tag/v1.0.0-rc.1).
Registry publication is deferred until the provider has an independent repository, Registry-format
documentation, signed checksums, and its own qualification path.
</Warning>
