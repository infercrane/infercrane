...
SGLang is InferCrane's second registered inference engine. v0.6 pins the official
...
manifest digest during v0.6 implementation; the immutable value is visible through
...
performance and provider shutdown behavior—remains deferred until the consolidated v1 manual
qualification. Autoscaling is rejected for SGLang in v0.6 because normalized SGLang scaling
