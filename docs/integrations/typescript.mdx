...
The npm `rc` tag resolves to the public beta. Use the SDK version from the same InferCrane release as
the control plane; stable `1.0.0` remains reserved for the stable release.
