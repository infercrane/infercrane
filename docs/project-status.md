...
| Separate operations console | Private preview | Endpoint-first views, durable operations, Request Inspector, Doctor, Release Guard, API-key/team management, encrypted local sessions, hosted identity boundaries, explicit partial states, responsive Playwright and accessibility tests pass locally; hosted deployment remains private. |
