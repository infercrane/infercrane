...
Approval records a bounded authority window. It does not automatically promote a candidate. Campaign
execution remains separately qualification-gated; canceling a campaign prevents future work and
marks unfinished candidates stale. Closing the CLI does not remove persisted campaign state.
