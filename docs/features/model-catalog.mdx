...
evidence. The catalog also exposes `custom-oci-blackwell-tep4` as an explicitly unqualified four-B200
candidate for environments where the H200 node shape is unavailable; selecting it does not create a
support claim.
