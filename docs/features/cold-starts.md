...
startup, artifact download, model load, and runtime initialization through the OpenAI-compatible
vLLM request. InferCrane therefore reports the machine-readable bottleneck code
