...
The current release reports only sourced cost that InferCrane can bind to the selected workload and
window. Cost per request, per-token unit economics, idle-capacity attribution, and verified savings
