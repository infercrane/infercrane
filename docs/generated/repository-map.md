...
| `internal/benchmark` | 1 | 1 | `TestParseRecordsMeasuresAIPerfMetrics`, `TestReproductionCommandDoesNotPersistDeletedTemporaryPath`, `TestReproductionCommandRedactsCredential`, `TestRunReportsMissingAIPerf` |
