...
| `internal/reconcile` | 1 | 1 | `TestRouterCandidateFailureLeavesOldGenerationServing`, `TestRouterCandidatePublishesBeforeOldRetires`, `TestServerlessRouteDoesNotWarmWorkersOrStartRouter`, `TestUnchangedGenerationUsesGenerationProcessIdentity` |
...
| `internal/workflows` | 5 | 4 | `TestApplyExistingHandlerIsDeterministic`, `TestApplyExistingHandlerRejectsInvalidPayload`, `TestBadCandidateIsRejectedAndCapacityIsDeleted`, `TestCandidateCancellationDeletesOnlyCandidateCapacity`, `TestCandidateProvisioningCreatesIsolatedRevisionCapacity`, `TestConvergeCancellationDeletesProviderResource`, `TestConvergeCreatesExactlyOneResourcePerMinimumReplica`, `TestConvergeResumesAfterProviderCheckpoint`, `TestEnsureCloudReplicaClassifiesFailedProviderRequest`, `TestEnsureCloudReplicaStopsAndCleansFailedRuntimeJob`, `TestGuardedPromotionCutsOverBeforeDeletingOldCapacity`, `TestRejectedCandidateProvisionRetryOnlyResumesCleanup`, `TestReplicaBackendsRejectAmbiguousRegistrations`, `TestReplicaBackendsResolveByCloudRuntimeAndDurableName`, `TestRolloutHandlersPersistExplicitTransitions`, `TestScaleDownWithdrawsRouterBeforeDeletingReplica`, `TestServerlessConvergeRegistersScaleToZeroEndpointWithoutWarmingWorker`, `TestServerlessDeleteConfirmsEndpointAbsentBeforeDeletingDeployment`, `TestServerlessDeleteDoesNotPersistDeletionWhileRecoveredEndpointRemains`, `TestServerlessDeleteRecoversEndpointByDurableNameWhenCreateResponseWasLost` |
