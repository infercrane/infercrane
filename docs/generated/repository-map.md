...
| `internal/workflows` | 5 | 4 | `TestApplyExistingHandlerIsDeterministic`, `TestApplyExistingHandlerRejectsInvalidPayload`, `TestBadCandidateIsRejectedAndCapacityIsDeleted`, `TestCandidateCancellationDeletesOnlyCandidateCapacity`, `TestCandidateProvisioningCreatesIsolatedRevisionCapacity`, `TestConvergeCancellationDeletesProviderResource`, `TestConvergeCreatesExactlyOneResourcePerMinimumReplica`, `TestConvergeResumesAfterProviderCheckpoint`, `TestEnsureCloudReplicaClassifiesFailedProviderRequest`, `TestGuardedPromotionCutsOverBeforeDeletingOldCapacity`, `TestRejectedCandidateProvisionRetryOnlyResumesCleanup`, `TestReplicaBackendsRejectAmbiguousRegistrations`, `TestReplicaBackendsResolveByCloudRuntimeAndDurableName`, `TestRolloutHandlersPersistExplicitTransitions`, `TestScaleDownWithdrawsRouterBeforeDeletingReplica`, `TestServerlessConvergeRegistersScaleToZeroEndpointWithoutWarmingWorker`, `TestServerlessDeleteConfirmsEndpointAbsentBeforeDeletingDeployment`, `TestServerlessDeleteDoesNotPersistDeletionWhileRecoveredEndpointRemains`, `TestServerlessDeleteRecoversEndpointByDurableNameWhenCreateResponseWasLost` |
