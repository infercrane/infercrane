...
| `internal/workflows` | 5 | 4 | `TestApplyExistingHandlerIsDeterministic`, `TestApplyExistingHandlerRejectsInvalidPayload`, `TestBadCandidateIsRejectedAndCapacityIsDeleted`, `TestCandidateCancellationDeletesOnlyCandidateCapacity`, `TestCandidateProvisioningCreatesIsolatedRevisionCapacity`, `TestConvergeCancellationDeletesProviderResource`, `TestConvergeCreatesExactlyOneResourcePerMinimumReplica`, `TestConvergeResumesAfterProviderCheckpoint`, `TestEnsureCloudReplicaClassifiesFailedProviderRequest`, `TestEnsureCloudReplicaStopsAndCleansFailedRuntimeJob`, `TestGuardedPromotionCutsOverBeforeDeletingOldCapacity`, `TestGuardedPromotionWaitsForRetiringRequests`, `TestProviderCapacityMessageDoesNotInventUnavailableStages`, `TestProviderCapacityMessageUsesGroundedPlacementDetails`, `TestRejectedCandidateProvisionRetryOnlyResumesCleanup`, `TestReplicaBackendsRejectAmbiguousRegistrations`, `TestReplicaBackendsResolveByCloudRuntimeAndDurableName`, `TestRolloutHandlersPersistExplicitTransitions`, `TestScaleDownWithdrawsRouterBeforeDeletingReplica`, `TestServerlessConvergeRegistersScaleToZeroEndpointWithoutWarmingWorker`, `TestServerlessDeleteConfirmsEndpointAbsentBeforeDeletingDeployment`, `TestServerlessDeleteDoesNotPersistDeletionWhileRecoveredEndpointRemains`, `TestServerlessDeleteRecoversEndpointByDurableNameWhenCreateResponseWasLost` |
