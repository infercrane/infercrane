...
<div className="ic-hero not-prose">
  <div className="ic-kicker"><span className="ic-status-dot"></span> v1.1 endpoint development</div>
...
<CardGroup cols={2}>
  ...
  <Card title="See production patterns" icon="sparkles" href="/showcase/index">
    Connect an existing stack, reject a bad release, and operate through uncertain capacity.
  </Card>
</CardGroup>
