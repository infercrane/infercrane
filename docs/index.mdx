...
<Tip>
`Qwen/Qwen3-8B` is the repeatable release-acceptance model, not a product restriction. Use another
Hugging Face model identity or an immutable custom OCI workload when its runtime, hardware, license,
and protocol requirements have been qualified.
</Tip>
...
<CardGroup cols={2}>
  ...
  <Card title="See production patterns" icon="sparkles" href="/showcase/index">
    Deploy a model, connect an existing stack, compose gateways and sandboxes, and reject a bad release.
  </Card>
</CardGroup>
