...
| Provider, runtime, serving-topology and metrics adapters | `internal/provision`, `internal/runtime`, `internal/runtimecontract`, `internal/servingcontract`, `internal/metrics` | Integration maintainer |
| Operational evidence ingestion | `internal/metrics`, `internal/store/operational_measurements.go`, `internal/store/monitoring.go`, `cmd/infercrane/telemetry.go` | Integration, database, and security maintainers |
...
| Fleet and inference decision policy | `internal/autoscale`, `internal/capacity`, `internal/decision`, `internal/optimizer`, `internal/overflow`, `internal/authz`, `internal/pricing` | Control-plane maintainer |
| Optimization campaigns, capability compilation, and optimized artifact provenance | `internal/optimizationcampaign`, `internal/optimizationcapability`, `internal/optimizedartifact`, `internal/store/optimization_campaigns.go`, `internal/store/optimized_artifacts.go`, `cmd/infercrane/optimize.go`, `cmd/infercrane/optimized_artifact.go` | Control-plane, integration, and security maintainers |
...
| Provider connections and gateway composition | `internal/store/provider_connections.go`, `internal/controlapi`, `internal/external`, `cmd/infercrane/providers.go` | Security, gateway, and developer-experience maintainers |
