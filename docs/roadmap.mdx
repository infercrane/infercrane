...
6. **Expand by adapters:** runtimes, clouds, external APIs, and future sandbox or training lineage stay
   behind narrow contracts.

Sandbox execution and training orchestration are not part of the current release. If added, InferCrane
will track their identity, evidence, policy, and handoff while delegating isolation and training
execution to qualified systems. Managed compute remains demand-gated because it adds billing, abuse,
capacity, and support obligations—not just another adapter.
