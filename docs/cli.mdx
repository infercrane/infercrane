...
The optional preview console is a reconnectable, read-only view of deployments, active operations,
Release Guard decisions, and durable events. It requires an interactive terminal and never uses
tmux for persistence. See [Terminal operations console](/features/terminal-ui).
