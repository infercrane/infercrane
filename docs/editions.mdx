...
Apache-2.0 is deliberately used for the core so individuals and organizations can inspect, modify,
and self-operate the product under a permissive license with explicit contributor patent terms. A
proprietary service does not change the license of the public core, and mixing proprietary source
into this repository is not required for Cloud or Enterprise operation.
