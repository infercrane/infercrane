...
| SGLang 0.5.12 `runtime` candidate | `sha256:7de5f60ce864919b15af674de1f1b0223121ee42e83bb58f4f3aee16fb18ccfd` | 11,896,018,638 | 26 | Rejected by real AWS readiness qualification; not a production default |

The SGLang runtime candidate is 1,096,688,885 compressed bytes (8.44%) smaller than the current
default for this exact version. Real AWS qualification rejected it before readiness: the published
image repeatedly exited with `ModuleNotFoundError: No module named 'distro'`. InferCrane retained
the already-qualified full image. This is why transfer size alone never authorizes a runtime-image
change.
