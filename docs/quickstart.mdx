...
<Steps>
  <Step title="Open the private-preview repository">
    InferCrane is currently distributed to approved preview users. Authenticate GitHub CLI with the
    invited account, then clone the repository:
    ...
    If you have not received repository access, [join the private preview](https://infercrane.com/#private-preview).
  </Step>
...
The Homebrew formula and release archives are prepared but not yet publicly released. Approved
preview users can build the CLI from their authenticated repository checkout:
