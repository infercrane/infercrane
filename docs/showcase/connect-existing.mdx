...
The recording is generated from [`scripts/demo-connect.sh`](https://github.com/infercrane/infercrane/blob/main/scripts/demo-connect.sh)
against GPU-free local fixtures. It proves the product workflow, not real-runtime performance.
