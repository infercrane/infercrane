...
<Warning>
The commands above use the external-reference contract: InferCrane does not
create, pause, snapshot, isolate, or delete those sandboxes. The separate
private-tenant Brezel preview can own an approved native lifecycle, but it does
not change the ownership of E2B, Modal, Kubernetes, or other external systems.
</Warning>
