...
flowchart LR
  ...
  IC -. explicit budgeted overflow .-> OR[OpenRouter]
...
## Use OpenRouter only as governed overflow

OpenRouter is an optional external capacity target, not an implicit default. Configure it with a
