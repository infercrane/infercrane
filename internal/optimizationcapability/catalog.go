...
func V1() (Registry, error) {
	descriptors := []Descriptor{
		...
		{ID: "vllm-0.22.1-lmcache-mp-v1", Mechanism: KVReuse, Runtime: "vllm", RuntimeVersion: support.DefaultRuntimeVersion, Models: reviewedModels, ArtifactPrecisions: []string{"bf16", "fp16", "fp8"}, Accelerators: commonAccelerators, Parameters: map[string][]string{"connector": {"LMCacheMPConnector"}}, Compiler: "lmcache-lifecycle-required", State: Deferred, Evidence: "docs:docs/features/optimization.mdx#upstream-composition-roadmap", Upstream: "https://docs.lmcache.ai/getting_started/quickstart.html", License: "apache-2.0"},
