...
func V1() (Registry, error) {
	descriptors := []Descriptor{
		{ID: "vllm-0.22.1-continuous-batching-v1", Mechanism: ContinuousBatching, Runtime: "vllm", RuntimeVersion: support.DefaultRuntimeVersion, Models: reviewedModels, ArtifactPrecisions: []string{"bf16", "fp16", "fp8", "awq", "gptq"}, Accelerators: commonAccelerators, Compiler: "runtime-owned", State: LocalQualified, Evidence: "go:test/internal/optimizationcapability#TestV1CompilesOnlyQualifiedExactTuples", Upstream: "https://docs.vllm.ai/en/latest/configuration/optimization/", License: "apache-2.0"},
		{ID: "vllm-0.22.1-prefix-cache-v1", Mechanism: PrefixCaching, Runtime: "vllm", RuntimeVersion: support.DefaultRuntimeVersion, Models: reviewedModels, ArtifactPrecisions: []string{"bf16", "fp16"}, Accelerators: commonAccelerators, Compiler: "vllm-prefix-cache", State: LocalQualified, Evidence: "go:test/internal/optimizationcapability#TestV1CompilesOnlyQualifiedExactTuples", Upstream: "https://docs.vllm.ai/en/latest/features/automatic_prefix_caching/", License: "apache-2.0", Limitations: []string{"Benefit requires repeated prompt prefixes and must be measured on the intended workload."}},
		{ID: "vllm-0.22.1-chunked-prefill-budget-v1", Mechanism: ChunkedPrefill, Runtime: "vllm", RuntimeVersion: support.DefaultRuntimeVersion, Models: reviewedModels, ArtifactPrecisions: []string{"bf16", "fp16"}, Accelerators: commonAccelerators, Parameters: map[string][]string{"max_num_batched_tokens": {"integer:256..1048576"}}, Compiler: "vllm-batch-token-budget", State: LocalQualified, Evidence: "go:test/internal/optimizationcapability#TestV1CompilesOnlyQualifiedExactTuples", Upstream: "https://docs.vllm.ai/en/latest/configuration/optimization/", License: "apache-2.0", Limitations: []string{"Token budget trades prefill throughput against decode latency and memory; benchmark each workload."}},
		{ID: "vllm-0.22.1-attention-backend-v1", Mechanism: AttentionBackend, Runtime: "vllm", RuntimeVersion: support.DefaultRuntimeVersion, Models: reviewedModels, ArtifactPrecisions: []string{"bf16", "fp16", "fp8"}, Accelerators: commonAccelerators, Parameters: map[string][]string{"backend": {"flashinfer", "flash-attention", "triton"}}, Compiler: "not-enabled", State: Deferred, Evidence: "docs:docs/features/optimization.mdx#upstream-composition-roadmap", Upstream: "https://docs.vllm.ai/en/latest/configuration/optimization/", License: "apache-2.0", Limitations: []string{"Backend choice is model, GPU, CUDA, and shape dependent; no universal default."}},
		{ID: "vllm-0.22.1-weight-precision-v1", Mechanism: WeightPrecision, Runtime: "vllm", RuntimeVersion: support.DefaultRuntimeVersion, Models: reviewedModels, ArtifactPrecisions: []string{"fp8", "awq", "gptq"}, Accelerators: []string{"H100", "H200", "L40S"}, Parameters: map[string][]string{"format": {"fp8", "awq", "gptq"}}, Compiler: "artifact-required", State: Deferred, Evidence: "docs:docs/features/optimization.mdx#upstream-composition-roadmap", Upstream: "https://docs.vllm.ai/en/latest/features/quantization/", License: "apache-2.0"},
		{ID: "vllm-0.22.1-kv-cache-precision-v1", Mechanism: KVCachePrecision, Runtime: "vllm", RuntimeVersion: support.DefaultRuntimeVersion, Models: reviewedModels, ArtifactPrecisions: []string{"bf16", "fp16", "fp8"}, Accelerators: []string{"H100", "H200", "L40S"}, Parameters: map[string][]string{"dtype": {"fp8_e4m3", "fp8_e5m2"}}, Compiler: "quality-gate-required", State: Deferred, Evidence: "docs:docs/features/optimization.mdx#upstream-composition-roadmap", Upstream: "https://docs.vllm.ai/en/latest/features/quantization/quantized_kvcache/", License: "apache-2.0"},
		{ID: "vllm-0.22.1-speculative-v1", Mechanism: SpeculativeDecode, Runtime: "vllm", RuntimeVersion: support.DefaultRuntimeVersion, Models: []string{"Qwen/Qwen3-8B", "meta-llama/Llama-3.1-8B-Instruct"}, ArtifactPrecisions: []string{"bf16", "fp16", "fp8"}, Accelerators: []string{"H100", "H200", "L40S"}, Parameters: map[string][]string{"method": {"eagle3", "mtp", "dflash", "draft-model", "ngram"}}, Compiler: "speculator-artifact-required", State: Deferred, Evidence: "docs:docs/features/optimization.mdx#upstream-composition-roadmap", Upstream: "https://github.com/vllm-project/speculators", License: "apache-2.0"},
		{ID: "vllm-0.22.1-lmcache-v1", Mechanism: KVReuse, Runtime: "vllm", RuntimeVersion: support.DefaultRuntimeVersion, Models: reviewedModels, ArtifactPrecisions: []string{"bf16", "fp16", "fp8"}, Accelerators: commonAccelerators, Parameters: map[string][]string{"connector": {"LMCacheConnectorV1"}}, Compiler: "serving-contract-translation-deferred", State: Deferred, Evidence: "go:test/internal/servingcontract#TestDeferredLMCacheTranslationIsExactAndCannotCompile", Upstream: "https://docs.lmcache.ai/getting_started/quickstart/offload_kv_cache.html", License: "apache-2.0"},
		{ID: "dynamo-prefill-decode-v1", Mechanism: Disaggregated, Runtime: "vllm", RuntimeVersion: support.DefaultRuntimeVersion, Models: reviewedModels, ArtifactPrecisions: []string{"bf16", "fp16", "fp8"}, Accelerators: []string{"H100", "H200", "L40S"}, Parameters: map[string][]string{"transport": {"nixl"}}, Compiler: "serving-contract-translation-deferred", State: Deferred, Evidence: "go:test/internal/servingcontract#TestDeferredNIXLTranslationIsRuntimeSpecificAndCannotCompile", Upstream: "https://github.com/ai-dynamo/dynamo", License: "apache-2.0"},
