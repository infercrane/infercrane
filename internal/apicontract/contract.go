...
var Routes = []Route{
	...
	{"GET", "/sandboxes", "listSandboxes", "Sandboxes", "List native sandbox lifecycle state without command, file, prompt, or output content", "", "ObjectList", 200, false},
	{"POST", "/sandboxes", "createSandbox", "Sandboxes", "Create a no-internet sandbox from an approved immutable template", "Object", "Object", 202, true},
	{"GET", "/sandboxes/{id}", "getSandbox", "Sandboxes", "Inspect one native sandbox lifecycle", "", "Object", 200, false},
	{"POST", "/sandboxes/{id}/pause", "pauseSandbox", "Sandboxes", "Pause a native sandbox", "", "Object", 202, true},
	{"POST", "/sandboxes/{id}/resume", "resumeSandbox", "Sandboxes", "Resume a native sandbox", "", "Object", 202, true},
	{"DELETE", "/sandboxes/{id}", "deleteSandbox", "Sandboxes", "Delete a native sandbox and begin provider cleanup", "", "Object", 202, true},
