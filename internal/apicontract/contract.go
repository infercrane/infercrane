...
func schemas() map[string]any {
	...
	return map[string]any{
		...
		"LabEvaluationRequest":            map[string]any{"type": "object", "additionalProperties": false, "required": []string{"model_identity"}, "properties": map[string]any{"model_identity": map[string]any{"type": "string", "minLength": 1}, "objective": map[string]any{"type": "string", "default": "latency", "enum": []string{"latency", "throughput", "cost-efficiency"}}, "workload_profile": map[string]any{"type": "string", "enum": []string{"balanced", "buffered", "interactive", "long-context", "long-generation", "overload", "throughput"}}, "max_ttft_p95_ms": map[string]any{"type": "number", "minimum": 0}, "workload_digest": map[string]any{"type": "string", "pattern": "^[a-f0-9]{64}$"}}},
