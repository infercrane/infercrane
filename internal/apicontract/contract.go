...
var Routes = []Route{
	...
	{"POST", "/optimization/campaigns/{id}/approve", "approveOptimizationCampaign", "Inference optimization", "Grant bounded expiring paid-resource authority without starting execution", "OptimizationCampaignApproval", "Object", 200, false},
	{"POST", "/optimization/campaigns/{id}/cancel", "cancelOptimizationCampaign", "Inference optimization", "Cancel future campaign work and require cleanup", "Object", "Object", 200, false},
...
func schemas() map[string]any {
	...
	return map[string]any{
		...
		"OptimizationCampaignCreate":      map[string]any{"type": "object", "additionalProperties": false, "required": []string{"proposal"}, "properties": map[string]any{"proposal": map[string]any{"type": "object", "description": "A complete infercrane.optimizer.proposal/v1 document whose normalized digest is revalidated by the server."}}},
