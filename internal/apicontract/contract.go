...
func schemas() map[string]any {
	...
	return map[string]any{
		...
		"ProviderConnectionCreate":        map[string]any{"type": "object", "additionalProperties": false, "required": []string{"name", "adapter", "target", "secret_reference_id"}, "properties": map[string]any{"name": map[string]any{"type": "string"}, "adapter": map[string]any{"type": "string", "enum": []string{"openrouter", "openai-compatible-external"}}, "target": map[string]any{"type": "string"}, "secret_reference_id": map[string]any{"type": "string"}}},
		...
		"BenchmarkRequest":                map[string]any{"type": "object", "required": []string{"requests", "concurrency"}, "properties": map[string]any{"requests": map[string]any{"type": "integer", "minimum": 1, "maximum": 100000}, "concurrency": map[string]any{"type": "integer", "minimum": 1}, "input_tokens": map[string]any{"type": "integer", "minimum": 1, "maximum": 1000000, "default": 128}, "output_tokens": map[string]any{"type": "integer", "minimum": 1, "maximum": 1000000, "default": 32}, "random_seed": map[string]any{"type": "integer", "default": 17}, "revision": map[string]any{"type": "string"}}},
		...
		"LabEvaluationRequest":            map[string]any{"type": "object", "additionalProperties": false, "required": []string{"model_identity"}, "properties": map[string]any{"model_identity": map[string]any{"type": "string", "minLength": 1}, "max_ttft_p95_ms": map[string]any{"type": "number", "minimum": 0}, "workload_digest": map[string]any{"type": "string", "pattern": "^[a-f0-9]{64}$"}}},
